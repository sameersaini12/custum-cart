...
var renderItems = function renderItems(items) {
  ...
  return parsedItems.map(function (menuitem) {
    return "\n                <p>".concat(menuitem.item.title, " - ").concat(menuitem.qty, " pcs</p>\n            ");
  }).join('');
};

var generateMarkup = function generateMarkup(orders) {
  return orders.map(function (order) {
    return "\n            <tr>\n                <td>\n                    <p>".concat(order._id, "</p>\n                    <div> ").concat(renderItems(order.items), " </div>\n                </td>\n                <td> ").concat(order.customerId.name, " </td>\n                <td> ").concat(order._id, " </td>\n                <td>\n                    <div>\n                        <form action=\"/admin/order/status\" method=\"POST\">\n                            <input type=\"hidden\" name=\"orderId\" value=\"").concat(order._id, "\" />\n                            <select name=\"status\" onchange=\"this.form.submit()\">\n                                <option value=\"order-placed\" ").concat(order.status === 'order-placed' ? 'selected' : '', ">Order Placed</option>\n                                <option value=\"order-accepted\" ").concat(order.status === 'order-accepted' ? 'selected' : '', ">Order Accepted</option>\n                                <option value=\"out-of-delivery\" ").concat(order.status === 'out-of-delivery' ? 'selected' : '', ">Out of Delivery</option>\n                                <option value=\"comming-soon\" ").concat(order.status === 'comming-soon' ? 'selected' : '', ">Comming Soon</option>\n                                <option value=\"delivered\" ").concat(order.status === 'delivered' ? 'selected' : '', ">Delivered</option>\n                            </select>\n                        </form>\n                    </div>\n                </td>\n                <td>\n                    ").concat(moment__WEBPACK_IMPORTED_MODULE_1___default()(order.createdAt).format('hh:mm A'), "\n                </td>\n                <td>\n                    ").concat(order.paymentStatus ? 'Paid' : 'Not Paid', "\n                </td>\n            </tr>");
  }).join('');
};
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === order.status) {
      stepCompleted = false;
      time.innerHTML = moment__WEBPACK_IMPORTED_MODULE_1___default()(order.createdAt).format('hh:mm A');
...
socket.on('orderUpdated', function (data) {
  var updateOrder = _objectSpread({}, order);

  updateOrder.updateAt = moment__WEBPACK_IMPORTED_MODULE_1___default()().format();
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcustumcart"] = self["webpackChunkcustumcart"] || [];
